...
class Dog:     def \_\_init\_\_(self, name, age):         self.name = name         self.age = age     def bark(self):         print("Woof!")     def display\_info(self):         print("Name:", self.name)         print("Age:", self.age)
...
\# Create objects of the Dog class dog1 = Dog("Buddy", 5) dog2 = Dog("Max", 3) # Call methods on the objects dog1.bark()               # Output: "Woof!" dog1.display\_info()       # Output: "Name: Buddy", "Age: 5" dog2.bark()               # Output: "Woof!" dog2.display\_info()       # Output: "Name: Max", "Age: 3"
...
`from Employees import Employees e1 = Employees("Bob", "Sales", "Director of Sales", 100000, 20) e2 = Employees("Linda", "Executive", "CIO", 150000, 10) print(e1.name) print(e2.role) print(e1.eligible_for_retirement())`
